...
function SlidesShow() {
    ...
    return (
        <div className="slideshow-container">
            ...
            <button className="prev" onClick={() => changeSlides(-1)}><img src="/icon-previous.svg" alt="icon previous" /></button>
            <button className="next" onClick={() => changeSlides(1)}><img src="/icon-next.svg" alt="icon next" /></button>
        </div>
    )
}
